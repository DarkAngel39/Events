local BOSS_OMEN = 15467
local NPC_LIGHT = 15902
local NPC_MINION_OF_OMEN = 15466
local SPELL_CLEAVE = 15284
local SPELL_STARFALL = 26540
local SPELL_SUMMON_SPOTLIGHT = 26392
local SPELL_ELUNE_BLESSING = 26393
local SPELL_ELUNE_BLESSING_CREDIT = 26394
local GO_ELUNE_TRAP_1 = 180876
local GO_ELUNE_TRAP_2 = 180877
local ZONE_MOONGLADE = 493
local QUEST_ELUNE_BLESSING = 8868
