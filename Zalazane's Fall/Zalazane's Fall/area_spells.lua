local ZONE_DUROTHAR = 14
local AREA_ECHOISLES = 368
local QUEST_DA_PERFECT_SPIES = 25444
local QUEST_FROGS_A = 25446
local QUEST_PREP_FOR_BATTLE = 25495
local QUEST_ZALAZANEFALL = 25445
local SPELL_SEE_FROGS = 75434
local SPELL_SEE_FROGG_SPIES = 74982 
local SPELL_EIPHASE = 74092 -- adds phase 256
