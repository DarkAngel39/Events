...
If the event has another folder included next to the sql files, you will need to move them into your server's
script folder. They contain some scripts related to that event. Don't forget to remove the scripts related
to the spawned event from your core scripts folder after you despawn the event.